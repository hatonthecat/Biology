...
Paired with the above map, one can speculate where this eddy can be observed in today's world. If testing in a laboratory setting, one can observe the mechanistic replication of bacteria in a petri dish, given enough nutrients, etc. If testing an early evolutionary era, prior to the formation of archaea, eukaryota, one might need to account for the anaerobic or oxygen-poor atmosphere of the Pre-Cambrian era. If testing prior to the formation of earth (the theory whereby symmetry breaking and molecule formation arose sometime after spinning off from a neutron star, then the conditions to test this theory require laboratory instruments capable of withstanding hotter temperatures (e.g.. fusion reactor such as a Tokomak). But if the quantities observed/formed cannot be produced in sizeable enough quantities (i.e the way PCR- Polymerase Chain Reaction thermocycling amplified copies of DNA), then a different math model may be needed before a laboratory test can be devised. Something like a Mass Spectrometer for a particle accelerator capable of producing sizeable quanities of precursor molecules that led to the production of life would be needed. Perhaps a thermocycler for elementary particles- quarks, gluons, those sort of things.  
