...
There may be five epochs. There may be seven epochs. And some of these epochs may have been much shorter than others. Some amount of punctuated equilibrium must have occured, and some phases could have happened within a day (not metaphorically referring to years or millenia). But it's very possible that from elemental particles (Hydrogen, Helium and so on,) that the later universe that led to carbon-based life comprised of a number of epochs that cannot be experimentally deduced from the early Big Bang, but by working backwards from the Ribosome.
