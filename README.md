...
There may be five epochs. There may be seven epochs. Or seventy And some of these epochs may have been much shorter than others. Some amount of punctuated equilibrium must have occured, and some phases could have happened within a day (not metaphorically referring to years or millenia). But it's very possible that between elemental particles (Hydrogen, Helium and so on,) and the later universe that led to carbon-based life comprised of a number of epochs, are a number of phases that cannot be experimentally deduced (+deduced and abductively hypothesized) from the early Big Bang, but by working backwards from the Ribosome.
